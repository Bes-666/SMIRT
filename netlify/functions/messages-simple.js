// Упрощенная версия без Blobs - использует переменные окружения
// Для production лучше использовать версию с Blobs (messages.js)

// Временное хранилище (в реальном приложении используйте БД или Blobs)
// Внимание: данные не сохраняются между перезапусками функций
let messagesCache = [];
